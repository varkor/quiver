...
\begin{center}
    \begin{tblr}{cc}
        ...
        \begin{tikzcd}[ampersand replacement=\&]
        	{} \& {}
        	\arrow[multimap, from=1-1, to=1-2]
        \end{tikzcd}
    \end{tblr}
\end{center}
...
\begin{center}
    \begin{tblr}{colspec={ccX[c]},row{even}=black!5}
        ...
        1.7.0 & 2026-07-26 & Added the \texttt{coil}, \texttt{coil'}, and \texttt{multimap} styles, and a dependency on \textsf{tikz-nfold}.
    \end{tblr}
\end{center}
